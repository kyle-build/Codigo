...
export default function WechatLogin() {
  ...
  const classNames = useMemo(() => {
    return ClassNames({
      ...
      "flex items-center justify-center rounded-md text-sm font-medium duration-500 border h-10 px-4 py-2 w-full bg-[#00b32c] text-white hover:bg-green-500 active:text-black mb-2": true,
    });
