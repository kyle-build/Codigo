...
import { PublishReleaseModal } from "@/modules/editor/components/header/center/publish-release-modal";
import { PublishTemplateModal } from "@/modules/editor/components/header/center/publish-template-modal";
import type { PublishReleaseModalValues } from "@/modules/editor/components/header/center/publish-release-modal.config";
import {
  useEditorComponents,
  useEditorPage,
  useEditorPermission,
...
} from "@/modules/editor/utils/publish-template";
